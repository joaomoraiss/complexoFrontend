  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error('Erro detalhado da resposta do backend (Juntase):', errorText); 
      ...
      console.log('Cadastro bem-sucedido (Juntase), dados recebidos:', data); 

      const userRole = data.role; 

      localStorage.setItem(userRole === "CLIENTE" ? "cliente" : "estudio", JSON.stringify(data));
      navigate(userRole === "CLIENTE" ? "/perfil-usuario" : "/perfil-estudio");
      

    } catch (error) {
      console.error('Erro de conexão ou requisição (Juntase):', error); 
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-8">
      ...
      <form className="max-w-3xl mx-auto" onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label className="block mb-1">{role === "STUDIO" ? "Nome do Estúdio:" : "Seu Nome:"}</label>
