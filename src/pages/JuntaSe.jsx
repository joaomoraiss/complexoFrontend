...
const JuntaSe = () => {
  const [role, setRole] = useState("CLIENTE"); // substitui tipoUsuario
  ...
  const handleSubmit = (e) => {
    ...
    const userKey = role === "CLIENTE" ? "cliente" : "estudio";
    localStorage.setItem(userKey, JSON.stringify({ tipo: role, ...formData }));
    navigate(userKey === "cliente" ? "/perfil-usuario" : "/perfil-estudio");
  };
