...
const Navbar = () => {
  ...
  const linkHoverEffect = 'relative text-base font-light before:absolute before:top-full before:left-0 before:w-0 before:h-[1px] before:bg-black before:transition-all before:duration-300 hover:before:w-full';
  ...
  return (
    <header className="sticky top-0 left-0 w-full shadow-md px-[15%] py-2.5 bg-white text-black flex items-center justify-between z-50">
      ...
      <div className={`${isMenuOpen ? 'flex flex-col items-center absolute top-[5rem] left-0 w-full bg-white py-4 z-40 border-t border-gray-300' : 'hidden sm:flex space-x-[60px]'}`}>
